    ...
    public partial class mig5 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationRoleEndpoint", x => new { x.EndpointsId, x.RolesId });
                    table.ForeignKey(
                        name: "FK_ApplicationRoleEndpoint_AspNetRoles_RolesId",
                        column: x => x.RolesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationRoleEndpoint_RolesId",
