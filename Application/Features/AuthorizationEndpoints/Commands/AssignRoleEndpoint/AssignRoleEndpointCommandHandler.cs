...
namespace EvosancomAPI.Application.Features.AuthorizationEndpoints.Commands.AssignRoleEndpoint
{
	public class AssignRoleEndpointCommandHandler : IRequestHandler<AssignRoleEndpointCommandRequest, AssignRoleEndpointCommandResponse>
	{
		...
		{
			await _authorizationEndpointService.
				AssingRoleEndpointAsync(request.Roles, request.Menu,
